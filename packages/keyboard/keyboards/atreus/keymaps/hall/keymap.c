...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
        ...
        _______, TO(3),   KC_HYPR, L_OUTER, L_THUMB, L_INNER, R_INNER, R_THUMB, R_OUTER, MOD_MEH, _______, _______),
    LAYOUT(
    ...
    LAYOUT(
        ...
        KC_WH_U, KC_BTN3, KC_MS_U, KC_BTN1, KC_BTN2,                   KC_MUTE, _______, KC_UP,   _______, RESET,
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
    LAYOUT(
        MI_OCTU, MI_MODSU, MI_TRNSU, MI_MOD,  MI_SUS,                    _______, MI_C,    MI_Cs,   MI_D,    MI_Ds,
